...
const REVIEWS = {
    ...
    totalCount: 20915,
    items: [
        { name: "INDHUMATHI M", initials: "I", body: "Policymine is doing really great. Absolutely spam free — that's the best part. They don't talk to you like they are forced to sell the product. It's more like, helping us buy better." },
...
const WHY_US = {
    ...
    items: [
        ...
        { heading: "100% Free Consultation", body: "Absolutely free, unbiased advice from IRDAI-certified advisors." },
...
async function seedPages() {
    ...
    await upsert("term-life/best-term-insurance-plans", {
        ...
        published: true,
        seo: {
            metaTitle: "Best Term Insurance Plans in India 2026 — Expert Picks",
        ...
        blocks: [
            { id: "bti-hero", type: "hero", data: { title: "Best Term Insurance Plans in India (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "bti-intro", type: "rich_text", data: { content: "<p>Choosing the right term insurance plan is one of the most important financial decisions you'll make. With dozens of plans available, we've done the hard work — rating plans on Claim Settlement Ratio (CSR), Amount Settlement Ratio (ASR), solvency ratio, complaint volumes, and premium affordability to bring you only the best recommendations for 2026.</p><p>Our top pick for 2026 is the <strong>Axis Max Life Smart Term Plan Plus</strong>, backed by a 99.62% average CSR over FY 2022–25 and a competitive annual premium of ₹17,222 for a 25-year-old seeking ₹2 crore cover up to age 65.</p>" } },
            ...
            { id: "bti-how-to-choose", type: "rich_text", data: { content: "<h2>How Do We Rate the Best Term Insurance Plans?</h2><p>At Policymine, we use a rigorous, data-driven framework to evaluate every plan:</p><ul><li><strong>Claim Settlement Ratio (CSR):</strong> Percentage of death claims settled out of total received. Higher is better — look for 97%+.</li><li><strong>Amount Settlement Ratio (ASR):</strong> Percentage of the total claim amount paid out. This catches insurers who settle small claims but reject large ones.</li><li><strong>Solvency Ratio:</strong> Measures the insurer's ability to meet long-term obligations. IRDAI mandates a minimum of 1.5x — we prefer 2x+.</li><li><strong>Complaint Volume:</strong> Fewer complaints per 10,000 claims signals better customer service and smoother operations.</li><li><strong>Premium Affordability:</strong> The plan must offer competitive premiums without sacrificing quality coverage.</li><li><strong>Riders & Features:</strong> Genuinely useful add-ons like critical illness coverage and waiver of premium distinguish great plans from average ones.</li></ul>" } },
            { id: "bti-premiums", type: "comparison_table", data: { title: "Premium Comparison — ₹2 Crore Cover until Age 65 (Non-Smoker, Delhi, Annual)", columns: ["Profile", "Axis Max Life", "HDFC Life", "ICICI Prudential", "Bajaj Life"], rows: [
                ["25, Male", "₹17,222", "₹19,719", "₹16,111", "₹17,450"],
                ["25, Female", "₹14,640", "₹16,761", "₹13,694", "₹14,800"],
                ["30, Male", "₹20,656", "₹25,153", "₹19,283", "₹20,900"],
                ["30, Female", "₹17,558", "₹21,380", "₹16,391", "₹17,750"],
                ["35, Male", "₹27,340", "₹33,211", "₹25,600", "₹27,800"],
            ] } },
            { id: "bti-eligibility", type: "features_table", data: { title: "General Eligibility Criteria for Term Plans", note: "Criteria may vary between insurers and plans.", rows: [
                { aspect: "Entry Age", feature: "Minimum 18 years; Maximum 60–65 years (varies by plan)." },
                { aspect: "Sum Assured", feature: "Usually ₹25 lakh minimum. No upper cap for most plans (subject to underwriting)." },
            ...
            { id: "bti-faq", type: "faq", data: { items: [
                { question: "Which is the No. 1 term insurance plan in India?", answer: "Based on our 2026 analysis, Axis Max Life Smart Term Plan Plus ranks first due to its 99.62% CSR, 96.37% ASR, critical illness rider covering 64 conditions, and competitive premiums starting at ₹17,222 per year for a 25-year-old." },
                { question: "How much term insurance cover do I need?", answer: "At Policymine, we recommend the expense and liability replacement method. Your cover should be enough to replace your income for the years your family depends on it, plus repay all outstanding loans, plus fund key goals like children's education. For most 30-year-olds, this works out to ₹1.5–3 crore." },
                ...
                { question: "Should I buy term insurance online or through an agent?", answer: "Online purchases are typically 10–20% cheaper because they skip commission costs. Platforms like Policymine let you compare multiple plans, get free expert advice, and buy directly — combining the savings of online with the guidance of an advisor." },
            ] } },
    ...
    await upsert("term-life/top-term-insurance-companies", {
        ...
        published: true,
        seo: {
            metaTitle: "Top Term Insurance Companies in India 2026 — Ratings & CSR",
    ...
    await upsert("term-life/compare-term-insurance-plans", {
        ...
        published: true,
        seo: {
            metaTitle: "Compare Term Insurance Plans India 2026 — Side by Side",
        ...
        blocks: [
            { id: "ctp-hero", type: "hero", data: { title: "Compare Term Insurance Plans (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "ctp-faq", type: "faq", data: { items: [
                ...
                { question: "Should I add the return of premium (TROP) option?", answer: "We generally don't recommend TROP at Policymine. TROP premiums are 60–125% higher than standard plans, and the returned premium has no real return — it's not indexed for inflation. Investing the premium difference in mutual funds or FDs will almost always give you a better financial outcome." },
            ] } },
    ...
    await upsert("term-life/term-plans-explained", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Plans Explained — Types, Features & How They Work",
        ...
        blocks: [
            { id: "tpe-hero", type: "hero", data: { title: "Term Plans Explained — Everything You Need to Know", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "tpe-intro", type: "rich_text", data: { content: "<p>A term plan is the simplest, purest form of life insurance. You pay a fixed premium for a fixed period. If you pass away during that period, your family receives the sum assured. If you survive, the coverage ends. No maturity benefit, no investment component — just clean, affordable protection.</p><p>This guide explains everything about term plans: how they work, what types exist, which riders matter, how premiums are calculated, and what to watch out for.</p>" } },
            { id: "tpe-cta1", type: "cta_block", data: GENERIC_CTA("term plans and how they work") },
            { id: "tpe-how-works", type: "how_it_works_steps", data: { title: "How a Term Plan Works — Step by Step", steps: [
                { text: "<strong>Choose your sum assured:</strong> The lump sum your family will receive. Most advisors recommend 15–20x your annual income, adjusted for loans and goals." },
                { text: "<strong>Select a policy term:</strong> The number of years you want coverage. Most people aim for coverage until age 60–65, or until their youngest dependent becomes financially independent." },
                ...
                { text: "<strong>Claim:</strong> If you pass away during the policy term, your nominee notifies the insurer and receives the death benefit within 15–45 days." },
            ] } },
            { id: "tpe-types", type: "types_list", data: { title: "Types of Term Insurance Plans", items: [
                ...
                { type: "Increasing Cover Term Insurance", feature: "Sum assured increases annually (usually by 5–10%) to account for inflation. Premiums are higher but coverage keeps pace with rising costs.", example: "HDFC Life Click2Protect Supreme Plus (Income Replacement Option)" },
                ...
                { type: "Return of Premium (TROP)", feature: "Returns base premiums if you survive the policy term. Premiums are 60–125% higher. The 'returned' amount is not inflation-adjusted. We don't recommend this.", example: "Axis Max Life, HDFC Click2Protect (TROP variant)" },
            ...
            { id: "tpe-eligibility", type: "features_table", data: { title: "Standard Eligibility Criteria for Term Plans", note: "Parameters vary between plans and insurers.", rows: [
                { aspect: "Entry Age", feature: "18 to 60–65 years (some plans allow entry up to 70)." },
                { aspect: "Maturity Age", feature: "23 to 85 years (up to 99–100 for whole-life variants)." },
                { aspect: "Sum Assured", feature: "Minimum ₹25 lakh. No upper cap (subject to underwriting and income multiples)." },
            ...
            { id: "tpe-verdict", type: "policymine_take", data: { title: "Policymine's Take on Term Plans", body: "Term insurance is the most efficient way to protect your family financially. It does one job — replace your income if you're gone — and it does it extremely well at a low cost. Don't mix it with investment. Don't buy TROP to 'get your money back'. Buy a pure term plan, add a critical illness rider if you can afford it, and invest the rest separately. That's the formula we recommend to every Policymine customer." } },
            { id: "tpe-faq", type: "faq", data: { items: [
                { question: "What happens to my term plan if I stop paying premiums?", answer: "If you miss a premium within the grace period, the policy lapses. After the grace period ends, coverage stops. Most policies have a revival provision allowing you to reinstate the policy within 2–5 years of lapsation by paying all outstanding premiums plus interest." },
                { question: "Can I get term insurance with a pre-existing disease?", answer: "Yes, but the insurer may charge a higher premium (called a loading), exclude the specific condition from coverage, or in rare cases decline the application. Always disclose pre-existing conditions accurately — non-disclosure can lead to claim rejection, negating the entire purpose of the policy." },
                { question: "Is term insurance premium tax-deductible?", answer: "Under the old tax regime, premiums up to ₹1.5 lakh per year qualify for deduction under Section 80C. The death benefit received by the nominee is fully tax-exempt under Section 10(10D), regardless of tax regime. The GST component of the premium is not tax-deductible." },
            ] } },
    ...
    // 5. Best ₹1 Crore Term Plans
    await upsert("term-life/best-1-crore-term-plans", {
        pageKey: "term-life/best-1-crore-term-plans",
        title: "Best ₹1 Crore Term Insurance Plans",
        section: "term-life",
        published: true,
        seo: {
            metaTitle: "Best ₹1 Crore Term Insurance Plans in India 2026",
            metaDescription: "Find the best ₹1 crore term insurance plans in India 2026 with lowest premiums, highest CSR, and best riders.",
            keywords: ["1 crore term insurance", "best 1 crore term plan", "term insurance 1 crore premium"],
        },
        blocks: [
            { id: "oct-hero", type: "hero", data: { title: "Best ₹1 Crore Term Insurance Plans (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "oct-intro", type: "rich_text", data: { content: "<p>A ₹1 crore term plan is often the starting point for young professionals looking to secure their family's financial future. With annual premiums as low as ₹8,000–₹12,000 for a 25-year-old, it's one of the most affordable forms of financial protection available.</p><p>This guide covers the best ₹1 crore term plans, how premiums vary by age and gender, which riders to add, and whether ₹1 crore is actually enough for your needs.</p>" } },
            { id: "oct-cta1", type: "cta_block", data: GENERIC_CTA("the best ₹1 crore term plan for your profile") },
            { id: "oct-premiums", type: "comparison_table", data: { title: "₹1 Crore Term Insurance Premium Comparison (Cover Until Age 65, Non-Smoker, Delhi)", columns: ["Profile", "Axis Max Life", "HDFC Life", "ICICI Prudential", "Bajaj Life"], rows: [
                ["25, Male", "₹8,611", "₹9,860", "₹8,055", "₹8,725"],
                ["25, Female", "₹7,320", "₹8,381", "₹6,847", "₹7,400"],
                ["30, Male", "₹10,328", "₹12,577", "₹9,641", "₹10,450"],
                ["30, Female", "₹8,779", "₹10,690", "₹8,195", "₹8,875"],
                ["35, Male", "₹13,670", "₹16,605", "₹12,800", "₹13,900"],
                ["40, Male", "₹19,440", "₹24,100", "₹18,200", "₹19,750"],
            ] } },
            ...
            { id: "oct-is-enough", type: "rich_text", data: { content: "<h2>Is ₹1 Crore Enough? How to Decide Your Sum Assured</h2><p>₹1 crore may be the minimum cover for a young professional, but whether it's <em>enough</em> depends on several factors:</p><ul><li><strong>Annual Expenses:</strong> If your family spends ₹8 lakh per year, ₹1 crore covers 12–13 years at current spending — which may not be sufficient for a young family.</li><li><strong>Outstanding Loans:</strong> If you have a ₹60 lakh home loan, your actual protection need is ₹1 crore + ₹60 lakh minimum.</li><li><strong>Inflation:</strong> ₹1 crore today will be worth far less in 20–30 years due to inflation.</li><li><strong>Income Replacement:</strong> A common rule is 15–20x annual income. If you earn ₹10 lakh per year, your target cover is ₹1.5–2 crore minimum.</li></ul><p>At Policymine, we recommend a ₹2 crore cover for most working professionals. ₹1 crore is a good starting point for students or very early-career buyers who will increase cover as their income grows.</p>" } },
            { id: "oct-verdict", type: "policymine_take", data: { title: "Our Verdict on ₹1 Crore Plans", body: "For a first-time buyer, a ₹1 crore pure term plan from Axis Max Life Smart Term Plan Plus or HDFC Life Click2Protect Supreme Plus is a great starting point. The premium is low, the protection is meaningful, and you can top up coverage later with a separate plan. Don't stretch your budget — buy what you can sustain, then add more cover when your income grows." } },
            { id: "oct-faq", type: "faq", data: { items: [
                { question: "What is the premium for a ₹1 crore term plan for a 30-year-old?", answer: "For a 30-year-old healthy non-smoking male in a metro city, a ₹1 crore term plan covering until age 65 costs approximately ₹9,500–₹12,500 per year, depending on the insurer. Women typically pay 15–20% less due to higher life expectancy." },
                { question: "Can I get a ₹1 crore term plan without a medical test?", answer: "Some insurers offer non-medical (NME) term plans for lower sum assureds or specific age brackets. However, for ₹1 crore coverage, most insurers will require at least a basic medical checkup. At Policymine, we always recommend completing medical tests even when not mandatory — it ensures your claim is never challenged later." },
                { question: "Should I buy two ₹50 lakh plans or one ₹1 crore plan?", answer: "One ₹1 crore plan from a single highly-rated insurer is generally better. Managing multiple policies means multiple renewals, multiple claim processes for your nominee, and potentially slightly higher total premiums due to smaller policy administrative costs." },
            ] } },
            { id: "oct-cta2", type: "cta_block", data: { title: "Get a personalised ₹1 crore term plan quote in minutes — completely free.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
            { id: "oct-reviews", type: "reviews", data: REVIEWS },
        ],
    })

    // ══════════════════════════════════════════════════════════════════════════
    // TERM LIFE — For Your Profile
    // ══════════════════════════════════════════════════════════════════════════
    ...
    await upsert("term-life/term-insurance-for-senior-citizens", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance for Senior Citizens India 2026 — Guide & Plans",
        ...
        blocks: [
            { id: "tsc-hero", type: "hero", data: { title: "Term Insurance for Senior Citizens (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "tsc-intro", type: "rich_text", data: { content: "<p>Getting term insurance as a senior citizen (typically 60+) is challenging — premiums are significantly higher, eligibility criteria are stricter, and many plans have maximum entry age limits of 60–65. However, options do exist, and if you have dependents or outstanding liabilities, it may be worth exploring.</p><p>This guide covers what's available for senior citizens, realistic expectations on premiums, and whether term insurance is even the right solution for your specific needs.</p>" } },
            ...
            { id: "tsc-eligibility", type: "features_table", data: { title: "Term Insurance Eligibility for Senior Citizens", note: "These are general ranges. Always verify with the specific insurer.", rows: [
                { aspect: "Maximum Entry Age", feature: "Most plans: 60–65 years. Some plans (whole life variants): up to 70 years." },
                { aspect: "Minimum Sum Assured", feature: "₹25–50 lakh minimum. High cover may not be available above 65." },
                ...
                { aspect: "Premium Level", feature: "Significantly higher than younger age groups — often 4–8x the premium of a 30-year-old." },
                { aspect: "Policy Term", feature: "Usually limited to coverage until age 75–85. Whole life options available with some plans." },
            ] } },
            { id: "tsc-premium-note", type: "note_box", data: { label: "Premium Reality Check", content: "A 60-year-old non-smoking male seeking ₹50 lakh cover until age 75 pays approximately ₹55,000–₹75,000 per year. This is substantially higher than for younger buyers and may not be cost-effective in many scenarios." } },
            { id: "tsc-alternatives", type: "rich_text", data: { content: "<h2>Is Term Insurance the Right Choice for Senior Citizens?</h2><p>If you are 60+ and still have financial dependents or significant outstanding liabilities (like a business loan), term insurance can provide meaningful protection. However, consider these alternatives:</p><ul><li><strong>Senior Citizen Health Insurance:</strong> A far more critical need at this age — comprehensive health plans like Star Senior Citizen Red Carpet cover medical expenses that spike in later years.</li><li><strong>Existing Coverage Review:</strong> Check if your existing term plan already covers you adequately. Many people have term plans that run until age 65–75.</li><li><strong>Investment-Based Protection:</strong> Building a corpus through FDs, PPF, or mutual funds may be more cost-effective than high-premium term insurance at 60+.</li><li><strong>Whole Life Annuity Plans:</strong> If estate planning is the goal, whole-life plans from LIC or private insurers may serve better than pure term plans.</li></ul>" } },
            ...
            { id: "tsc-faq", type: "faq", data: { items: [
                ...
                { question: "What is the best insurance for a senior citizen in India?", answer: "Comprehensive health insurance is usually the most valuable coverage for senior citizens — Star Senior Citizen Red Carpet, Niva Bupa Senior First, and HDFC Ergo Easy Health plans are well-regarded. For life cover, existing term plans (if still active) or whole-life plans may be relevant." },
            ] } },
    ...
    await upsert("term-life/term-insurance-for-housewife", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance for Housewife — Can a Homemaker Get a Term Plan?",
        ...
        blocks: [
            { id: "thw-hero", type: "hero", data: { title: "Term Insurance for Housewives & Homemakers (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "thw-intro", type: "rich_text", data: { content: "<p>Yes, housewives and homemakers can get term insurance in India. While the eligibility rules are different from earning members — since most insurers tie sum assured to income multiples — a growing number of plans specifically accommodate non-earning spouses.</p><p>The economic value of a homemaker (childcare, elder care, household management) is significant. If a homemaker passes away, the surviving working spouse would need to spend substantially on these services. Term insurance can provide that financial cushion.</p>" } },
            ...
            { id: "thw-eligibility", type: "features_table", data: { title: "Term Insurance Eligibility for Housewives", note: "Rules vary significantly between insurers. Always verify.", rows: [
                ...
                { aspect: "Sum Assured Limit", feature: "Usually capped at 50% of the working spouse's sum assured, or a fixed limit (e.g., ₹50 lakh max). Some plans now allow up to ₹1 crore." },
                { aspect: "Income Proof", feature: "Not required in most cases, since the cover is linked to the spouse's income." },
                { aspect: "Age Limit", feature: "Entry age 18–55 years for most plans." },
                { aspect: "Medical Tests", feature: "Required depending on sum assured and age." },
            ] } },
            { id: "thw-hdfc-option", type: "note_box", data: { label: "Spotlight: HDFC Life Click2Protect Supreme Plus", content: "HDFC Life's spouse cover option allows both spouses to be covered under a single policy. The housewife's coverage can be up to 50% of the primary policyholder's sum assured, with a maximum of ₹50 lakh. This is one of the most convenient options for homemakers." } },
            { id: "thw-why-important", type: "rich_text", data: { content: "<h2>Why Should a Homemaker Have Life Insurance?</h2><p>The economic contribution of a homemaker is often underestimated. Consider what the working spouse would need to pay for if the homemaker passed away:</p><ul><li>Professional childcare or daycare: ₹8,000–₹25,000 per month per child</li><li>Household help and cook: ₹5,000–₹15,000 per month</li><li>Elder care for parents: ₹10,000–₹30,000 per month</li><li>Emotional and mental health impact on children and spouse</li></ul><p>A ₹25–50 lakh term plan can provide enough financial buffer for 3–5 years while the family adjusts and stabilises. The premium for such a plan is typically ₹3,000–₹8,000 per year — very affordable.</p>" } },
            { id: "thw-verdict", type: "policymine_take", data: { title: "Policymine's Advice for Homemakers", body: "We strongly recommend that homemakers explore term insurance if affordable. The economic value of household work is real, and the premium for a ₹25–50 lakh plan is very low. Start with the HDFC Life spouse cover option or contact a Policymine advisor to check the latest standalone plans for non-earning spouses — the market has been evolving quickly in this area." } },
            ...
            { id: "thw-cta2", type: "cta_block", data: { title: "Explore term insurance options for homemakers — free, no-pressure consultation.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
        ],
    })
    ...
    await upsert("term-life/term-insurance-for-nri", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance for NRI — Can NRIs Buy Term Plans in India?",
        ...
        blocks: [
            { id: "nri-hero", type: "hero", data: { title: "Term Insurance for NRIs — A Complete Guide (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "nri-intro", type: "rich_text", data: { content: "<p>Yes, NRIs (Non-Resident Indians) can buy term insurance in India. In fact, having a term plan in India makes a lot of sense for NRIs — it protects family members living in India, and Indian term plans are significantly more affordable than equivalent life insurance in most countries abroad.</p><p>This guide covers everything NRIs need to know: eligibility, how to apply from abroad, premium payment methods, GST implications, and which plans are available.</p>" } },
            ...
            { id: "nri-eligibility", type: "features_table", data: { title: "NRI Term Insurance Eligibility", note: "Requirements vary by insurer. Some insurers are more NRI-friendly than others.", rows: [
                ...
                { aspect: "GST", feature: "18% GST applies on premiums paid in India. Premiums paid from foreign currency NRE accounts may be GST-exempt — check with your insurer." },
            ...
            { id: "nri-faq", type: "faq", data: { items: [
                ...
                { question: "What if an NRI passes away abroad — will the claim be settled?", answer: "Yes. Death outside India is covered under most term plans. The nominee will need to submit a death certificate that is apostilled or attested by the Indian Embassy in the country of death, along with standard claim documents." },
            ] } },
            { id: "nri-cta2", type: "cta_block", data: { title: "Get expert guidance on NRI term insurance options — we help NRIs worldwide.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
    ...
    await upsert("term-life/term-insurance-for-self-employed", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance for Self-Employed — Plans, Eligibility & Tips",
        ...
        blocks: [
            { id: "tse-hero", type: "hero", data: { title: "Term Insurance for Self-Employed Professionals (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "tse-intro", type: "rich_text", data: { content: "<p>Self-employed individuals — freelancers, business owners, consultants, and gig workers — often find term insurance applications more complex than salaried employees. The primary challenge is income proof, since many self-employed professionals have variable income and may not have traditional salary slips.</p><p>However, term insurance is arguably <em>more</em> critical for self-employed individuals than for salaried employees, since they typically lack employer-provided group life insurance or structured PF/gratuity benefits.</p>" } },
            { id: "tse-cta1", type: "cta_block", data: GENERIC_CTA("term insurance for self-employed professionals") },
            { id: "tse-challenges", type: "rich_text", data: { content: "<h2>Challenges Self-Employed Buyers Face</h2><ul><li><strong>Income Proof:</strong> Insurers typically require ITR (Income Tax Returns) for 2–3 years instead of salary slips. Business financials, CA-certified balance sheets, or bank statements may also be required.</li><li><strong>Variable Income:</strong> If your income fluctuates significantly year to year, insurers may average out your income for sum assured calculation.</li><li><strong>Higher Scrutiny:</strong> Self-employed applicants may face more underwriting questions about business stability, industry risk, and financial health.</li><li><strong>No Employer Group Cover:</strong> Unlike salaried employees, you have no fallback group term cover — making an individual term plan your sole financial safety net.</li></ul>" } },
            { id: "tse-income-proof", type: "features_table", data: { title: "Income Proof Documents for Self-Employed Applicants", note: "Requirements vary by insurer and cover amount.", rows: [
                { aspect: "ITR (Form 16 / ITR-3/4)", feature: "Most commonly required. 2–3 years of ITR returns are standard." },
                { aspect: "CA-Certified Financials", feature: "Balance sheet and P&L statement certified by a Chartered Accountant." },
                { aspect: "Bank Statements", feature: "6–12 months of bank statements showing regular cash flows." },
            ...
            { id: "tse-tip", type: "note_box", data: { label: "Policymine Tip", content: "File your ITR every year, even if your income is below the taxable limit. A 2–3 year ITR history is the single most important document for a self-employed term insurance application. Applicants without ITR history face significantly limited options and higher premiums." } },
            ...
            { id: "tse-faq", type: "faq", data: { items: [
                { question: "Can a freelancer get term insurance in India?", answer: "Yes. Freelancers with a documented income history (ITR, bank statements) can get term insurance. The sum assured will be capped based on the income multiple your insurer applies (usually 15–20x annual income)." },
                { question: "What if I have no ITR? Can I still get term insurance?", answer: "Options are very limited without ITR. Some insurers offer simplified underwriting for lower sum assureds (₹25–50 lakh) without income proof. For higher cover, ITR is almost always required. We strongly recommend filing ITR to build your documentation history." },
                { question: "Should self-employed individuals buy a higher sum assured?", answer: "Generally yes — because you lack employer-provided group life cover, EPF/gratuity death benefits, and other salaried safety nets. Budget permitting, aim for 20x your average annual income." },
            ] } },
    ...
    await upsert("term-life/term-insurance-for-smokers", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance for Smokers India 2026 — Plans & Premiums",
        ...
        blocks: [
            { id: "tsm-hero", type: "hero", data: { title: "Term Insurance for Smokers — Premiums, Plans & Tips (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "tsm-intro", type: "rich_text", data: { content: "<p>Smokers can absolutely get term insurance in India — but they pay significantly higher premiums than non-smokers. Insurers classify smoking as a major risk factor due to its well-documented impact on longevity. The premium difference is typically 40–70% higher than non-smoker rates.</p><p>This guide explains who counts as a smoker for insurance purposes, how much more you'll pay, why you should still disclose smoking honestly, and which plans are best for tobacco users.</p>" } },
            ...
            { id: "tsm-premiums", type: "comparison_table", data: { title: "Smoker vs Non-Smoker Premium Comparison (30-year-old Male, ₹2 Crore, Cover Until 65)", columns: ["Plan", "Non-Smoker Annual Premium", "Smoker Annual Premium", "Premium Increase"], rows: [
                ["Axis Max Life Smart Term Plan Plus", "₹20,656", "₹32,400", "+57%"],
                ["HDFC Life Click2Protect Supreme Plus", "₹25,153", "₹40,200", "+60%"],
                ["ICICI Prudential iProtect Smart Plus", "₹19,283", "₹30,100", "+56%"],
                ["Bajaj Life eTouch II", "₹20,900", "₹33,500", "+60%"],
            ] } },
            ...
            { id: "tsm-verdict", type: "policymine_take", data: { title: "Policymine's Advice for Smokers", body: "If you smoke, you absolutely still need term insurance — arguably more so, given the health risks. Buy at the smoker rate, declare honestly, and consider quitting. If you're able to quit for 12+ months, approach your insurer to reclassify your status — you may be able to reduce your premium going forward. Don't let the higher premium deter you from buying protection for your family." } },
            { id: "tsm-faq", type: "faq", data: { items: [
                ...
                { question: "Can I reduce my premium if I quit smoking after buying a policy?", answer: "Some insurers allow you to apply for reclassification after 12–36 months of documented abstinence. This typically involves a fresh medical test. If approved, your premium may be reduced to non-smoker rates for the remaining policy term." },
            ] } },
            { id: "tsm-cta2", type: "cta_block", data: { title: "Smoker or not — our advisors will find you the best available plan. No judgment, just honest advice.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
        ],
    })

    // ══════════════════════════════════════════════════════════════════════════
    // TERM LIFE — Benefits & Features
    // ══════════════════════════════════════════════════════════════════════════

    // 11. Section 80C Tax Benefits
    await upsert("term-life/section-80c-tax-benefits", {
        pageKey: "term-life/section-80c-tax-benefits",
        title: "Section 80C — Tax Benefits of Term Insurance",
        section: "term-life",
        published: true,
        seo: {
            metaTitle: "Section 80C Tax Benefits of Term Insurance 2026 — Guide",
            metaDescription: "Understand how term insurance premiums qualify for Section 80C deductions, the ₹1.5 lakh limit, new tax regime rules, and how to maximise your tax savings.",
            keywords: ["section 80c term insurance", "term insurance tax benefit", "80c deduction life insurance"],
        },
        blocks: [
            { id: "80c-hero", type: "hero", data: { title: "Section 80C — Tax Benefits of Term Insurance Explained", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "80c-intro", type: "rich_text", data: { content: "<p>Term insurance premiums qualify for tax deduction under Section 80C of the Income Tax Act, 1961, under the old tax regime. This allows you to reduce your taxable income by up to ₹1.5 lakh per year on eligible life insurance premium payments — making term insurance both a financial protection tool and a tax-saving instrument.</p>" } },
            ...
            { id: "80c-benefits", type: "features_table", data: { title: "Tax Benefits Available with Term Insurance", note: "Tax benefits apply under the old tax regime only, unless specified.", rows: [
                { aspect: "Section 80C", feature: "Deduction up to ₹1.5 lakh per year on premiums paid for life insurance policies (term plans). Old tax regime only." },
                ...
                { aspect: "Section 80D (Riders)", feature: "Premiums paid for health-related riders like Critical Illness or Hospital Care riders may qualify for additional deduction under Section 80D (₹25,000 for self/family; ₹50,000 for senior citizen parents). Old regime only." },
            ...
            { id: "80c-example", type: "rich_text", data: { content: "<h2>Section 80C Tax Saving — A Practical Example</h2><p>Assume you are in the 30% tax bracket and pay a ₹20,000 annual term insurance premium.</p><ul><li>Section 80C deduction: ₹20,000 (this reduces your taxable income by ₹20,000)</li><li>Tax saved: ₹20,000 × 30% = <strong>₹6,000 per year</strong></li><li>Effective premium after tax saving: ₹20,000 – ₹6,000 = <strong>₹14,000 per year</strong></li></ul><p>Note: If you have already exhausted your ₹1.5 lakh 80C limit with other investments (PPF, ELSS, EPF), your term insurance premium may not provide additional tax benefit beyond that limit.</p>" } },
            { id: "80c-new-regime", type: "note_box", data: { label: "New Tax Regime — Important Note", content: "If you have opted for the new tax regime (default from FY 2024–25), you cannot claim Section 80C deductions on term insurance premiums. However, the death benefit (Section 10(10D)) remains tax-free under both regimes. Evaluate whether the old regime gives you better overall tax savings before deciding." } },
    ...
    await upsert("term-life/term-insurance-benefits", {
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance Benefits — Key Features, Riders & Tax Advantages",
        ...
        blocks: [
            { id: "tib-hero", type: "hero", data: { title: "Term Insurance Benefits — Complete Feature Guide", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "tib-benefits", type: "benefits_list", data: { title: "Key Benefits of Term Insurance", items: [
                { heading: "High Sum Assured at Low Premium", body: "Term insurance offers the highest cover-to-premium ratio of any insurance product. A ₹1 crore cover costs as little as ₹8,000–₹10,000 per year for a 25-year-old." },
                ...
                { heading: "Critical Illness Coverage (Rider)", body: "A Critical Illness rider pays a lump sum on diagnosis of covered conditions like cancer, heart attack, or kidney failure — irrespective of the death benefit." },
                ...
                { heading: "Multiple Payout Options", body: "Receive the death benefit as a lump sum, monthly income, or a combination — giving your family flexibility in managing the payout." },
                { heading: "Tax Benefits", body: "Premiums up to ₹1.5 lakh qualify for Section 80C deduction (old regime). Death benefit is fully tax-free under Section 10(10D)." },
            ...
            { id: "tib-faq", type: "faq", data: { items: [
                { question: "What is the biggest benefit of term insurance over other life insurance products?", answer: "The single biggest advantage is the cover-to-premium ratio. A term plan gives you 20–30x more coverage per rupee of premium than endowment or ULIP plans. It does one job — protect your family financially if you're gone — and it does it exceptionally well at a low cost." },
                { question: "What happens if I survive the term plan period?", answer: "In a standard term plan, the coverage ends and nothing is paid out. This is by design — the low premium only covers the risk, not any investment return. You can renew or buy a new plan if you still have dependents. If you opted for TROP, your base premiums are returned." },
            ] } },
            { id: "tib-cta", type: "cta_block", data: { title: "Explore the full range of term insurance benefits for your specific profile — free consultation.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
    ...
    await upsert("health/what-is-health-insurance", {
        ...
        published: true,
        seo: {
            metaTitle: "What is Health Insurance? — Complete Guide for India (2026)",
        ...
        blocks: [
            { id: "whi-hero", type: "hero", data: { title: "What is Health Insurance?", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "whi-intro", type: "rich_text", data: { content: "<p>Health insurance is a contract between you and an insurer where the insurer agrees to cover your medical expenses — including hospitalisation, surgery, diagnostics, and pre/post-hospitalisation costs — in exchange for a regular premium payment.</p><p>In India, healthcare costs are rising at approximately 14% per year. A single hospitalisation event can cost ₹2–20 lakh depending on the condition and city. Health insurance ensures these costs don't derail your financial plan.</p><p>Our top recommendation for most individuals and families in 2026 is the <strong>HDFC Ergo Optima Restore</strong>, which offers no room rent restriction, no disease sub-limits, a strong restoration benefit, and access to 13,000+ network hospitals.</p>" } },
            ...
            { id: "whi-how-works", type: "how_it_works_steps", data: { title: "How Health Insurance Works in India", steps: [
                ...
                { text: "<strong>Network hospitals — cashless treatment:</strong> If you get treated at a hospital in the insurer's network, you don't pay out-of-pocket. The insurer settles the bill directly with the hospital." },
                { text: "<strong>Non-network hospitals — reimbursement:</strong> Pay the bill yourself and submit documents to the insurer for reimbursement within 30 days." },
                { text: "<strong>Waiting periods:</strong> Pre-existing conditions have a waiting period of 2–4 years. Specific diseases (like hernia, cataract) may have 1–2 year waiting periods. Accidents are typically covered from day one." },
                { text: "<strong>Claim settlement:</strong> For cashless claims, the insurer communicates directly with the hospital. For reimbursement, the insurer reviews submitted documents and settles within 15–30 days." },
            ...
            { id: "whi-key-features", type: "features_table", data: { title: "Key Features to Evaluate in a Health Insurance Plan", rows: [
                ...
                { aspect: "Co-payment", feature: "Some plans require you to pay 10–20% of every claim. Avoid policies with mandatory co-payment unless the premium savings are significant." },
                { aspect: "Disease Sub-limits", feature: "Caps on specific conditions (e.g., ₹50,000 for knee replacement). Prefer plans without sub-limits." },
                ...
                { aspect: "No Claim Bonus (NCB)", feature: "Increases your sum insured by 10–50% per year if you don't make a claim. Valuable for long-term policyholders." },
                { aspect: "Waiting Periods", feature: "Initial waiting period: 30 days. Pre-existing disease waiting period: 2–4 years. Maternity: 9–24 months." },
            ...
            { id: "whi-verdict", type: "policymine_take", data: { title: "Policymine's Verdict on Health Insurance", body: "Health insurance is not optional — it's a financial necessity in today's India. Rising medical costs, the explosion of lifestyle diseases, and the increasing frequency of critical illnesses make a robust health plan essential for every family. Buy early while you're healthy and premiums are low. A ₹10–20 lakh floater policy from a high-CSR insurer is the minimum we recommend for a family of 3–4. Don't cut corners here." } },
            { id: "whi-faq", type: "faq", data: { items: [
                { question: "What is the difference between health insurance and mediclaim?", answer: "Mediclaim is an older term that typically refers to basic hospitalisation-only reimbursement policies. Modern health insurance plans are comprehensive — they cover pre/post-hospitalisation, daycare procedures, domiciliary treatment, and often include wellness benefits. All mediclaim is health insurance, but not all health insurance is mediclaim." },
                { question: "Is employer-provided health insurance sufficient?", answer: "Usually not. Employer group plans often have low sum insured (₹1–5 lakh), limited hospital networks, and cease when you leave the job. Medical inflation means a ₹3 lakh group cover can be exhausted by a single hospitalisation event in a metro city. An individual or family floater plan is essential as a supplement." },
    ...
    await upsert("health/health-insurance-checklist", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance Checklist — 10 Things to Check Before Buying",
        ...
        blocks: [
            { id: "hic-hero", type: "hero", data: { title: "Health Insurance Checklist — 10 Things to Verify Before You Buy", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "hic-checklist", type: "numbered_cards", data: { title: "The Policymine Health Insurance Checklist", quickTake: "Verify all 10 factors before buying any health insurance plan.", cards: [
                { number: 1, title: "Claim Settlement Ratio (CSR)", body: "Check the insurer's CSR from the latest IRDAI annual report. Above 90% is excellent. Below 80% is a red flag. A high CSR means the insurer settles most claims without dispute." },
                { number: 2, title: "Room Rent Limit", body: "Check if the plan has a room rent cap (e.g., 1% of sum insured per day). Room rent limits drastically reduce your claim — all proportionate costs (doctor fees, ICU charges, etc.) are reduced pro-rata. Always prefer 'any room' or 'no room rent limit'." },
                { number: 3, title: "Co-payment Clause", body: "A co-pay of 10–20% means you pay that share of every claim. For a ₹5 lakh hospitalisation, you'd pay ₹50,000–₹1 lakh out of pocket. Avoid plans with mandatory co-payment unless the premium difference is significant." },
                { number: 4, title: "Disease Sub-limits", body: "Some plans cap payouts for specific conditions (e.g., ₹50,000 for cataract). These caps can leave you heavily under-compensated for expensive procedures. Prefer plans without sub-limits." },
                { number: 5, title: "Pre-existing Disease Waiting Period", body: "Most plans have a 2–4 year waiting period for pre-existing conditions. Check the exact period and what conditions are covered (and when). The shorter the waiting period, the better — especially if you have any existing health conditions." },
                { number: 6, title: "Restoration Benefit", body: "If your sum insured is exhausted mid-year, a restoration benefit reinstates it. Check if restoration applies to the same illness or only different illnesses — 'same illness restoration' is more valuable." },
                { number: 7, title: "No Claim Bonus (NCB)", body: "A good NCB increases your sum insured by 10–50% for each claim-free year. Check the maximum accumulation cap and whether NCB is in the form of a sum insured increase or premium discount." },
                ...
                { number: 10, title: "Portability Option", body: "Verify you can port this policy to another insurer later without losing waiting period credit. IRDAI mandates portability, but check specific terms for smooth transfer." },
            ] } },
            { id: "hic-verdict", type: "policymine_take", data: { title: "Policymine's Buying Checklist Bottom Line", body: "The best health insurance plan is one that protects you in a real hospitalisation scenario without hidden restrictions eroding your claim. Don't be seduced by low premiums — check room rent limits, co-pay, and sub-limits before anything else. HDFC Ergo Optima Restore passes all 10 checks for most buyers, which is why it's our top recommendation." } },
            { id: "hic-cta2", type: "cta_block", data: { title: "Let our advisors run this checklist against any plan you're considering — completely free.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
    ...
    await upsert("health/buy-health-insurance", {
        ...
        published: true,
        seo: {
            metaTitle: "How to Buy Health Insurance in India 2026 — Step-by-Step Guide",
        ...
        blocks: [
            { id: "bhi-hero", type: "hero", data: { title: "How to Buy Health Insurance — Step-by-Step Guide (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "bhi-steps", type: "how_it_works_steps", data: { title: "How to Buy Health Insurance in India — Step by Step", steps: [
                { text: "<strong>Step 1 — Assess your needs:</strong> Individual or family floater? How much sum insured? Are there existing health conditions? Do you need maternity cover? Are there senior citizen dependents?" },
                { text: "<strong>Step 2 — Shortlist insurers:</strong> Check CSR (90%+ preferred), number of network hospitals (8,000+), and track record (10+ years preferred). This narrows the field before you look at specific plans." },
                { text: "<strong>Step 3 — Compare plans:</strong> Within shortlisted insurers, compare room rent limits, co-payment clauses, sub-limits, waiting periods, and restoration benefits." },
                { text: "<strong>Step 4 — Get quotes for your exact profile:</strong> Input your age, family members, pincode, and sum insured to get actual premium quotes. Don't rely on headline minimum premiums." },
                { text: "<strong>Step 5 — Disclose accurately:</strong> Disclose all pre-existing conditions, medications, past surgeries, and family medical history honestly. Non-disclosure is the most common reason for claim rejection." },
                { text: "<strong>Step 6 — Complete medical tests if required:</strong> For applicants above 45 or for high sum insured amounts, medical tests are typically required. Don't skip or delay — the sooner you complete tests, the sooner your policy is issued." },
                { text: "<strong>Step 7 — Review the policy document:</strong> Use the 30-day free-look period to read the policy wording, especially exclusions and waiting periods. Return the policy within 30 days if anything is misrepresented." },
                { text: "<strong>Step 8 — Renew on time every year:</strong> Don't let your policy lapse. Continuous renewal preserves your waiting period credit, NCB accumulation, and claim history." },
            ] } },
            { id: "bhi-documents", type: "features_table", data: { title: "Documents Required to Buy Health Insurance", rows: [
                ...
                { aspect: "Income Proof", feature: "Not always required for individual health plans. May be needed for very high sum insured (₹25 lakh+)." },
            ] } },
            { id: "bhi-verdict", type: "policymine_take", data: { title: "Policymine's Buying Advice", body: "The most important thing when buying health insurance is honest disclosure. More claims are rejected due to non-disclosure than any other reason. Disclose everything — pre-existing conditions, past surgeries, family history. A knowledgeable advisor can help you choose a plan that covers your specific conditions with the shortest waiting period. At Policymine, we guide you through this entire process for free." } },
            { id: "bhi-cta2", type: "cta_block", data: { title: "Get expert guidance on buying the right health insurance — our advisors do this every day.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
            { id: "bhi-reviews", type: "reviews", data: REVIEWS },
        ],
    })

    // ══════════════════════════════════════════════════════════════════════════
    // HEALTH INSURANCE — Compare & Choose
    // ══════════════════════════════════════════════════════════════════════════
    ...
    await upsert("health/best-health-insurance-plans", {
        ...
        published: true,
        seo: {
            metaTitle: "Best Health Insurance Plans in India 2026 — Expert Picks",
        ...
        blocks: [
            { id: "bhp-hero", type: "hero", data: { title: "Best Health Insurance Plans in India (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "bhp-intro", type: "rich_text", data: { content: "<p>The best health insurance plan is not necessarily the cheapest or the one with the most features — it's the one that will actually pay your claims without hidden restrictions. Our 2026 ratings are based on Claim Settlement Ratio, room rent limits, co-payment clauses, disease sub-limits, restoration benefits, network hospital count, and premiums.</p><p>Our top recommendation for 2026 remains <strong>HDFC Ergo Optima Restore</strong> — no room rent restriction, no co-payment, no sub-limits, 100% restoration once per year, and access to 13,000+ hospitals.</p>" } },
            ...
            { id: "bhp-faq", type: "faq", data: { items: [
                { question: "Which health insurance has the best claim settlement ratio in India?", answer: "Among our rated plans, HDFC Ergo has a CSR of 96.7%, Care has 95.2%, Aditya Birla has 95.8%, and Niva Bupa has 91.6% (FY 2024-25). Star Health has a lower CSR at 84.9%. Always check the latest IRDAI annual report for current figures." },
                { question: "How much health insurance do I need?", answer: "For an individual in a metro city, a minimum of ₹10 lakh is recommended, with ₹20 lakh being the sweet spot. For a family of 4 in a metro, a ₹20–25 lakh floater is a starting point. Consider adding a super top-up plan for additional cover at a low additional premium." },
    ...
    await upsert("health/top-health-insurance-companies", {
        ...
        published: true,
        seo: {
            metaTitle: "Top Health Insurance Companies in India 2026 — Ratings & CSR",
        ...
        blocks: [
            { id: "thc-hero", type: "hero", data: { title: "Top Health Insurance Companies in India (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "thc-intro", type: "rich_text", data: { content: "<p>Your health insurance is only as good as the company behind it. An insurer with a poor claim settlement track record, limited hospital network, or weak financial health can leave you stranded during a medical emergency. This guide ranks India's top health insurance companies based on data from the IRDAI Annual Report 2024–25.</p>" } },
            ...
            { id: "thc-verdict", type: "policymine_take", data: { title: "Policymine's Top Health Insurer Picks", body: "HDFC Ergo is our top-rated private health insurer — strong CSR (96.7%), excellent network (13,000+ hospitals), and comprehensive product features. For buyers wanting maximum restoration flexibility, Niva Bupa ReAssure 2.0 is excellent. For those needing the widest hospital network, Care Supreme covers 22,000+ hospitals. Avoid insurers with CSR below 85%, especially Navi at 71.4%, which is significantly below industry average." } },
    ...
    await upsert("health/compare-health-insurance-plans", {
        ...
        published: true,
        seo: {
            metaTitle: "Compare Health Insurance Plans India 2026 — Side by Side",
        ...
        blocks: [
            { id: "chi-hero", type: "hero", data: { title: "Compare Health Insurance Plans (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "chi-comparison", type: "comparison_table", data: { title: "Health Insurance Plan Feature Comparison — Top Plans 2026", columns: ["Feature", "HDFC Ergo Optima Restore", "Niva Bupa ReAssure 2.0", "Care Supreme", "Aditya Birla Activ Health Enhanced"], rows: [
                ["Room Rent Limit", "Any Room ✅", "Any Room ✅", "Any Room ✅", "Any Room ✅"],
                ["Co-payment", "None ✅", "None ✅", "None ✅", "None ✅"],
                ["Disease Sub-limits", "None ✅", "None ✅", "None ✅", "None ✅"],
                ["Restoration Benefit", "100% once (any illness) ✅", "Unlimited (any illness) ✅", "100% once ✅", "100% once ✅"],
                ["No Claim Bonus", "50%/yr → 100% max ✅", "50%/yr → 100% max ✅", "50%/yr ✅", "50%/yr ✅"],
                ["Maternity Cover", "Not available ❌", "Add-on available ✅", "Add-on available ✅", "Add-on available ✅"],
                ["OPD Coverage", "Annual health check ✅", "Not available ❌", "OPD add-on ✅", "Extensive OPD ✅"],
                ["Network Hospitals", "13,000+ ✅", "10,000+ ✅", "22,000+ ✅", "10,500+ ✅"],
                ["CSR (FY 24-25)", "96.7% ✅", "91.6% ✅", "95.2% ✅", "95.8% ✅"],
                ["PM Rating", "4.5/5 ⭐", "4.3/5 ⭐", "4.2/5 ⭐", "4.1/5 ⭐"],
            ] } },
    ...
    await upsert("health/health-plans-explained", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Plans Explained — Types, Features & How to Choose (2026)",
            metaDescription: "A complete guide to understanding different types of health insurance plans in India — individual, family floater, critical illness, super top-up, and more.",
            keywords: ["health plans explained", "types of health insurance india", "health insurance guide"],
        },
        blocks: [
            { id: "hpe-hero", type: "hero", data: { title: "Health Plans Explained — Your Complete Guide", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "hpe-intro", type: "rich_text", data: { content: "<p>Health insurance comes in many forms — individual plans, family floaters, critical illness plans, super top-up plans, group plans, and more. Understanding the differences helps you build a protection framework that's both comprehensive and cost-effective.</p>" } },
            ...
            { id: "hpe-types", type: "types_list", data: { title: "Types of Health Insurance Plans in India", items: [
                { type: "Individual Health Insurance", feature: "Covers one person with a dedicated sum insured. Each family member's cover is separate and independent — a large claim by one doesn't affect others.", example: "HDFC Ergo Optima Restore (Individual), Niva Bupa ReAssure 2.0 (Individual)" },
                ...
                { type: "Super Top-Up Plan", feature: "Provides additional cover above a deductible threshold. Very cost-effective for boosting total cover. Example: ₹10 lakh base plan + ₹40 lakh super top-up = ₹50 lakh total cover at much lower total premium than a ₹50 lakh primary plan.", example: "HDFC Ergo Health Suraksha Plus, Star Super Surplus" },
            ...
            { id: "hpe-verdict", type: "policymine_take", data: { title: "Building the Right Health Cover Stack", body: "The optimal health coverage strategy for most families is: (1) A comprehensive individual or family floater plan from a top-rated insurer as the primary plan (₹10–25 lakh), plus (2) A super top-up plan for an additional ₹25–50 lakh of cover at a fraction of the additional cost. This gives you ₹35–75 lakh of total protection while keeping premiums manageable. Add a critical illness plan if anyone in the family is at elevated risk for heart disease or cancer." } },
    ...
    await upsert("health/claim-settlement-ratio-top-10", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance Claim Settlement Ratio — Top 10 Insurers (2026)",
            metaDescription: "Compare health insurance claim settlement ratios of the top 10 insurers in India based on IRDAI Annual Report 2024-25 data.",
            keywords: ["health insurance claim settlement ratio", "CSR health insurance india", "best claim settlement health insurer"],
        },
        blocks: [
            { id: "csr-hero", type: "hero", data: { title: "Health Insurance Claim Settlement Ratio — Top 10 (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "csr-intro", type: "rich_text", data: { content: "<p>The Claim Settlement Ratio (CSR) is one of the most important metrics when evaluating a health insurance company. It represents the percentage of claims settled out of the total claims received in a given year. A higher CSR means the insurer settles more claims and is less likely to dispute your hospitalisation bill.</p><p>Data sourced from the IRDAI Annual Report 2024–25.</p>" } },
            { id: "csr-cta1", type: "cta_block", data: GENERIC_CTA("choosing a health insurer based on CSR") },
            { id: "csr-table", type: "comparison_table", data: { title: "Health Insurance Claim Settlement Ratio — Top 10 Companies (FY 2024–25)", columns: ["Rank", "Insurance Company", "CSR (FY 24-25)", "Network Hospitals", "PM Verdict"], rows: [
                ["1", "New India Assurance", "98.9%", "8,000+", "✅ Excellent"],
                ["2", "Digit General Insurance", "98.6%", "6,800+", "✅ Excellent"],
                ["3", "HDFC Ergo General Insurance", "96.7%", "13,000+", "✅ Excellent"],
                ["4", "Bajaj Allianz General Insurance", "96.7%", "9,000+", "✅ Excellent"],
                ["5", "Acko General Insurance", "96.5%", "6,500+", "✅ Good"],
                ["6", "SBI General Insurance", "96.1%", "7,000+", "✅ Good"],
                ["7", "Aditya Birla Health Insurance", "95.8%", "10,500+", "✅ Good"],
                ["8", "Care Health Insurance", "95.2%", "22,000+", "✅ Good"],
                ["9", "National Insurance Company", "94.6%", "7,500+", "✅ Good"],
                ["10", "Niva Bupa Health Insurance", "91.6%", "10,000+", "✅ Good"],
            ] } },
            ...
            { id: "csr-verdict", type: "policymine_take", data: { title: "Policymine's CSR-Based Recommendation", body: "Based purely on CSR, New India Assurance and Digit top the list. However, CSR alone doesn't determine the best health insurer — product quality, room rent restrictions, network hospitals, and co-payment clauses all matter equally. Our top recommendation, HDFC Ergo (CSR 96.7%), combines a very high CSR with excellent product features and a large hospital network — making it the best overall choice for most buyers." } },
    ...
    await upsert("health/family-health-insurance", {
        ...
        published: true,
        seo: {
            metaTitle: "Family Health Insurance — Best Plans & Floater Guide 2026",
        ...
        blocks: [
            { id: "fhi-hero", type: "hero", data: { title: "Health Insurance for Family — Complete Guide (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "fhi-intro", type: "rich_text", data: { content: "<p>A family health insurance plan covers multiple family members under a single policy. The most common structure is a <strong>family floater plan</strong>, where a shared sum insured can be used by any covered member. For a family of 3–4 in a metro city, a ₹20–25 lakh floater plan from a top-rated insurer is our starting recommendation.</p>" } },
            { id: "fhi-cta1", type: "cta_block", data: GENERIC_CTA("family health insurance plans") },
            { id: "fhi-floater-vs-individual", type: "comparison_table", data: { title: "Family Floater vs Individual Health Plans — Which Is Right for You?", columns: ["Factor", "Family Floater Plan", "Individual Plans for Each Member"], rows: [
                ["Cost", "More affordable — one premium covers all", "Higher total premium — separate policy for each"],
                ["Sum Insured Usage", "Shared — one large claim reduces cover for all", "Independent — one person's claim doesn't affect others"],
                ["Best For", "Young families where all members are healthy", "Families with senior citizens who may file frequent claims"],
                ["Age Consideration", "Premium based on oldest member's age — increases significantly when parents are included", "Each plan priced by individual age — efficient for mixed-age families"],
                ["Ease of Management", "Single renewal, single premium payment", "Multiple policies to track and renew"],
                ["Restoration Benefit", "Applies to the shared pool — one restoration per year in most plans", "Individual restoration for each person's cover"],
            ] } },
            { id: "fhi-who-to-include", type: "rich_text", data: { content: "<h2>Who Should Be on a Family Health Plan?</h2><p>You can typically include the following on a family floater policy:</p><ul><li><strong>Self and spouse</strong> — Standard on all family plans.</li><li><strong>Dependent children</strong> — Usually covered until age 25 (some plans up to 23). Children born after the policy is issued can be added mid-term.</li><li><strong>Parents</strong> — Many plans allow you to include parents on the floater, but this significantly increases the premium (since premiums are based on the oldest member). We generally recommend separate senior citizen plans for parents above 60.</li><li><strong>Parents-in-law</strong> — Some plans include them; others require separate policies.</li></ul>" } },
            ...
            { id: "fhi-verdict", type: "policymine_take", data: { title: "Policymine's Family Health Insurance Advice", body: "For a young family (couple + children under 30), a ₹20–25 lakh HDFC Ergo Optima Restore family floater is our top pick. If you're planning to have children in the next 2 years, consider Niva Bupa ReAssure 2.0 with the maternity add-on (noting the waiting period). For parents above 60, always opt for separate individual or senior citizen plans — don't add them to the family floater." } },
            { id: "fhi-faq", type: "faq", data: { items: [
                { question: "How much family health insurance do I need?", answer: "For a family of 3–4 in a metro city, a ₹20–25 lakh floater is the minimum we recommend. If affordable, ₹25 lakh + a ₹25 lakh super top-up plan gives you ₹50 lakh of total cover at a much lower additional cost." },
    ...
    await upsert("health/health-insurance-for-senior-citizens", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance for Senior Citizens India 2026 — Best Plans",
        ...
        blocks: [
            { id: "hsc-hero", type: "hero", data: { title: "Health Insurance for Senior Citizens (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "hsc-intro", type: "rich_text", data: { content: "<p>Health insurance is arguably the most critical financial protection for senior citizens. Medical costs rise sharply with age, and without coverage, a single hospitalisation can wipe out years of savings. The good news: dedicated senior citizen health plans in India have improved significantly in coverage quality.</p><p>Senior citizen health plans for those above 60 come with higher premiums than standard plans (sometimes 3–5x), mandatory co-payment clauses in many plans, and modified waiting periods for pre-existing conditions. This guide helps you navigate these complexities.</p>" } },
            ...
            { id: "hsc-copay-warning", type: "note_box", data: { label: "Co-payment Warning for Senior Plans", content: "Most senior citizen health plans have a mandatory co-payment of 10–30% of every claim. This means for a ₹5 lakh hospitalisation, you'd pay ₹50,000–₹1.5 lakh out of pocket. Always check the co-payment percentage before buying, and compare the total out-of-pocket cost across plans." } },
            { id: "hsc-verdict", type: "policymine_take", data: { title: "Policymine's Senior Citizen Health Insurance Advice", body: "For parents above 60, we recommend evaluating Care Senior or Niva Bupa Senior First based on current premium and health status. Don't add senior parents to your family floater plan — their higher age pushes up the premium for the entire family, and one large claim can exhaust the floater for everyone. A separate ₹5–10 lakh senior citizen plan is usually the smarter choice." } },
            { id: "hsc-faq", type: "faq", data: { items: [
                { question: "What is the maximum age to buy health insurance in India?", answer: "Most standard plans allow entry up to age 65. Senior citizen specific plans allow entry up to 75 (and sometimes beyond). IRDAI has introduced guidelines mandating that insurers offer lifelong renewal, so you cannot be denied renewal solely due to age." },
                { question: "Are pre-existing diseases covered in senior citizen health plans?", answer: "Yes, but with a waiting period of 1–4 years depending on the plan. Care Senior covers many pre-existing conditions after 1 year, which is one of the shortest waiting periods available." },
            ] } },
            { id: "hsc-cta2", type: "cta_block", data: { title: "Get the best senior citizen health insurance for your parents — expert guidance for free.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
        ],
    })
    ...
    await upsert("health/maternity-health-insurance", {
        ...
        published: true,
        seo: {
            metaTitle: "Maternity Health Insurance India 2026 — Plans & Waiting Period Guide",
            metaDescription: "Everything about maternity coverage in health insurance — waiting periods, what's covered, best plans for expecting mothers, and how to plan your maternity cover.",
            keywords: ["maternity health insurance", "maternity cover health plan india", "pregnancy insurance india"],
        },
        blocks: [
            { id: "mhi-hero", type: "hero", data: { title: "Maternity Health Insurance — Complete Guide (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "mhi-intro", type: "rich_text", data: { content: "<p>Maternity health insurance covers childbirth-related expenses — pre-natal consultations, delivery (normal and caesarean), post-natal care, and in many plans, newborn baby cover. In India, the cost of childbirth in a private hospital ranges from ₹50,000 for a normal delivery to ₹1.5–3 lakh for a C-section, plus pre-natal and post-natal costs.</p><p><strong>Critical note:</strong> Most maternity plans have a waiting period of 9 months to 4 years. This means you need to buy the plan well before planning to get pregnant. If you're already pregnant, maternity costs will not be covered.</p>" } },
            ...
            { id: "mhi-coverage", type: "features_table", data: { title: "What Maternity Health Insurance Covers", rows: [
                ...
                { aspect: "Pre-natal Expenses", feature: "Consultations, diagnostic tests, ultrasounds before delivery. Usually covered for 30–60 days before admission." },
                { aspect: "Post-natal Expenses", feature: "Consultations and medications after delivery. Usually covered for 30–60 days after discharge." },
            ...
            { id: "mhi-plans", type: "plans_table", data: { title: "Best Maternity Health Insurance Plans 2026", rows: [
                { plan: "Niva Bupa ReAssure 2.0 (Maternity Add-on)", riders: "Waiting: 12 months, Normal ₹50K, C-sec ₹75K, Newborn from Day 1, unlimited restore", csr: "91.6%", rating: "4.4/5", policymineRating: 4.4 },
                { plan: "Care Supreme (Maternity Add-on)", riders: "Waiting: 12 months, Normal ₹35K, C-sec ₹50K, Newborn 90 days, 22,000+ hospitals", csr: "95.2%", rating: "4.3/5", policymineRating: 4.3 },
            ...
            { id: "mhi-timing", type: "note_box", data: { label: "When Should You Buy Maternity Cover?", content: "Buy maternity coverage at least 12–24 months before you plan to conceive. Most plans have a waiting period of 12–24 months (some as long as 4 years). Don't wait until you're planning — buy when you're young, healthy, and early in your marriage. The premium for maternity add-ons is very affordable at younger ages." } },
            { id: "mhi-verdict", type: "policymine_take", data: { title: "Policymine's Maternity Insurance Advice", body: "Plan your maternity insurance at least 1–2 years before you plan to start a family. Niva Bupa ReAssure 2.0 with the maternity add-on is our top pick for young couples — 12-month waiting period (shortest available), Day 1 newborn cover, and unlimited restoration if other hospitalisation needs arise. Always buy the comprehensive base plan first; maternity is an add-on benefit, not the primary purpose of health insurance." } },
            { id: "mhi-cta2", type: "cta_block", data: { title: "Plan your maternity coverage today — our advisors will guide you to the right plan.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
        ],
    })
    ...
    await upsert("health/health-insurance-for-parents", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance for Parents India 2026 — Best Plans",
        ...
        blocks: [
            ...
            { id: "hip-verdict", type: "policymine_take", data: { title: "Policymine's Parents' Health Insurance Advice", body: "Buy health insurance for your parents as soon as possible — ideally before they turn 65. Care Senior is our top recommendation for parents with pre-existing conditions due to its 1-year waiting period (shortest available). Niva Bupa Senior First offers a good balance of network size and coverage quality. The co-payment in senior plans is unavoidable — budget for it explicitly. A ₹5–10 lakh plan per parent is a practical starting point." } },
            { id: "hip-cta2", type: "cta_block", data: { title: "Protect your parents with the right health insurance plan — expert guidance, completely free.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
        ],
    })
    ...
    await upsert("health/health-insurance-for-children", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance for Children India 2026 — Best Plans",
        ...
        blocks: [
            { id: "hic2-hero", type: "hero", data: { title: "Health Insurance for Children — Guide & Best Plans (2026)", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "hic2-intro", type: "rich_text", data: { content: "<p>Children's healthcare expenses — infections, accidents, surgeries, and hospitalisation — can be significant. The question most parents face is: should you add your child to your family floater, or buy a separate plan for the child?</p><p>For most families, a family floater plan is the most cost-effective and practical solution. Children can be added to a family floater from birth (Day 91 for most plans). A separate individual plan for a child makes sense only in specific situations.</p>" } },
            ...
            { id: "hic2-coverage", type: "features_table", data: { title: "What Children's Health Insurance Covers", rows: [
                ...
                { aspect: "Day Care Procedures", feature: "Procedures requiring less than 24 hours hospitalisation — adenoidectomy, tonsillectomy, etc." },
    ...
    // ══════════════════════════════════════════════════════════════════════════
    // HEALTH INSURANCE — Benefits & Features
    // ══════════════════════════════════════════════════════════════════════════

    // 26. Section 80D Tax Benefits
    await upsert("health/section-80d-tax-benefits", {
        pageKey: "health/section-80d-tax-benefits",
        title: "Section 80D — Tax Benefits of Health Insurance",
        section: "health",
        published: true,
        seo: {
            metaTitle: "Section 80D Tax Benefits of Health Insurance 2026 — Complete Guide",
            metaDescription: "Understand Section 80D deductions for health insurance premiums in India — limits for self, family, and senior citizen parents, and how to maximise your tax savings.",
            keywords: ["section 80d health insurance", "health insurance tax benefit", "80d deduction limit"],
        },
        blocks: [
            { id: "80d-hero", type: "hero", data: { title: "Section 80D — Tax Benefits of Health Insurance Explained", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "80d-intro", type: "rich_text", data: { content: "<p>Section 80D of the Income Tax Act allows you to deduct health insurance premiums from your taxable income. This benefit is available under the old tax regime and can save you up to ₹13,000–₹19,500 per year in taxes (depending on your tax bracket) if you cover yourself, your family, and your parents.</p><p>The maximum deduction under Section 80D is ₹25,000 for self and family, plus an additional ₹25,000 (or ₹50,000 if parents are senior citizens) for parents — totalling up to ₹75,000 per year in deductions.</p>" } },
            { id: "80d-cta1", type: "cta_block", data: GENERIC_CTA("health insurance tax benefits under Section 80D") },
            { id: "80d-limits", type: "comparison_table", data: { title: "Section 80D Deduction Limits (FY 2025–26, Old Tax Regime)", columns: ["Category", "Maximum Deduction", "Condition"], rows: [
            ...
            { id: "80d-example", type: "rich_text", data: { content: "<h2>Section 80D Tax Saving — A Real Example</h2><p>Scenario: You are 35 (30% tax bracket), paying premiums for:</p><ul><li>Your family floater (self + spouse + child): ₹22,000 per year</li><li>Senior citizen parents' plan: ₹48,000 per year</li><li>Total premiums: ₹70,000 per year</li></ul><p><strong>Deduction calculation:</strong></p><ul><li>Section 80D (self + family): ₹22,000 deducted (maximum ₹25,000)</li><li>Section 80D (senior citizen parents): ₹48,000 deducted (maximum ₹50,000)</li><li>Total deduction: ₹70,000</li><li>Tax saved: ₹70,000 × 30% = <strong>₹21,000 per year</strong></li></ul>" } },
            ...
            { id: "80d-preventive-check", type: "rich_text", data: { content: "<h2>Preventive Health Check-Up Deduction</h2><p>Section 80D also allows a deduction of up to ₹5,000 for preventive health check-ups. This is included within the overall ₹25,000/₹50,000 limit — it doesn't provide an additional deduction on top. You can claim this even if you pay for health check-ups in cash (unlike insurance premiums, which must be paid digitally).</p>" } },
            ...
            { id: "80d-faq", type: "faq", data: { items: [
                { question: "Can I claim 80D for premiums paid for my parents' health insurance?", answer: "Yes. You can claim up to ₹25,000 (or ₹50,000 if parents are senior citizens) for premiums paid for your parents' health insurance, in addition to the deduction for your own policy. Both deductions can be claimed simultaneously." },
                { question: "Can I claim 80D if I pay my parents' health insurance premium in cash?", answer: "No. Section 80D requires premiums to be paid through non-cash modes (net banking, UPI, debit/credit card). Cash payments do not qualify for the deduction. However, the ₹5,000 preventive health check-up sub-limit within 80D does allow cash payments." },
                { question: "Can HUF (Hindu Undivided Family) claim 80D deductions?", answer: "Yes. A Hindu Undivided Family (HUF) can claim Section 80D deductions for premiums paid for health insurance of any member of the HUF, up to ₹25,000 per year." },
            ] } },
    ...
    await upsert("health/health-insurance-benefits", {
        ...
        published: true,
        seo: {
            metaTitle: "Health Insurance Benefits — Key Features & Advantages (2026)",
            metaDescription: "Comprehensive overview of health insurance benefits in India — cashless treatment, restoration, NCB, wellness benefits, tax savings, and more.",
            keywords: ["health insurance benefits", "advantages of health insurance", "health plan features india"],
        },
        blocks: [
            { id: "hib-hero", type: "hero", data: { title: "Health Insurance Benefits — Complete Feature Guide", publishedDate: "16 Jun, 2026", author: { name: "Avni Mittal", role: "Insurance Writer", photo: "/images/woman.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            ...
            { id: "hib-benefits", type: "benefits_list", data: { title: "Key Benefits of Health Insurance", items: [
                { heading: "Cashless Hospitalisation", body: "Get treated at 8,000–22,000+ network hospitals without paying out of pocket. The insurer settles the bill directly with the hospital." },
                { heading: "Pre & Post Hospitalisation Cover", body: "Covers diagnostic tests, consultations, and medications for 30–60 days before admission and 60–180 days after discharge." },
                { heading: "Restoration Benefit", body: "If your sum insured is exhausted during the policy year, it gets restored — either once (most plans) or unlimited times (premium plans like Niva Bupa ReAssure)." },
                { heading: "No Claim Bonus (NCB)", body: "Each claim-free year increases your sum insured by 10–50%, up to 100% in most plans — rewarding you for staying healthy." },
                { heading: "Day Care Procedures", body: "Covers procedures that don't require 24-hour hospitalisation — chemotherapy, dialysis, cataract surgery, and 500+ others." },
                { heading: "Annual Health Check-up", body: "Most top plans include a free annual health check-up package — preventive screening at no extra cost." },
                { heading: "Mental Health Coverage", body: "IRDAI mandates all health plans to cover mental illness treatment at par with physical illness, including inpatient psychiatric care." },
                { heading: "AYUSH Treatment Cover", body: "Covers Ayurveda, Yoga, Unani, Siddha, and Homeopathy treatments in AYUSH hospitals." },
                { heading: "Tax Benefits (Section 80D)", body: "Premiums up to ₹75,000 per year can be deducted from taxable income under Section 80D (old tax regime)." },
                { heading: "Lifelong Renewability", body: "IRDAI mandates that insurers cannot deny policy renewal solely due to age or health deterioration — your coverage continues as long as you renew." },
            ] } },
    ...
    await upsert("health/critical-illness-insurance", {
        ...
        published: true,
        seo: {
            metaTitle: "Critical Illness Insurance India 2026 — Plans, Benefits & Guide",
            metaDescription: "Everything about critical illness insurance in India — what it covers, how it differs from health insurance, best plans, and who should buy it.",
            keywords: ["critical illness insurance", "critical illness plan india", "cancer heart attack insurance india"],
        },
        blocks: [
            { id: "ci-hero", type: "hero", data: { title: "Critical Illness Insurance — Complete Guide (2026)", publishedDate: "16 Jun, 2026", author: { name: "Swetlana Neog", role: "Editorial Associate", photo: "/images/person3.png" }, reviewer: { name: "MS Bhati", role: "IRDAI-Certified Expert at Policymine", photo: "/images/person1.png" }, certificationId: "SP0738578124" } },
            { id: "ci-intro", type: "rich_text", data: { content: "<p>Critical illness insurance pays a lump sum benefit upon diagnosis of a serious illness — such as cancer, heart attack, stroke, kidney failure, or major organ transplant. This payout is independent of your actual medical expenses and independent of your regular health insurance claim.</p><p>Think of it as 'income replacement insurance for a serious illness'. When you're diagnosed with cancer, you don't just face hospital bills — you also face months of inability to work, travel costs for treatment, home care expenses, and psychological support costs. A critical illness payout covers all of this.</p>" } },
            ...
            { id: "ci-vs-health", type: "comparison_table", data: { title: "Critical Illness Insurance vs Regular Health Insurance", columns: ["Feature", "Critical Illness Insurance", "Regular Health Insurance"], rows: [
                ...
                ["Payout type", "Fixed lump sum (e.g., ₹25 lakh) paid directly to you", "Reimbursement or cashless payment to hospital"],
                ["Use of payout", "Any purpose — income replacement, home care, travel, debt", "Only medical expenses covered in the policy"],
                ["Premium", "Low — ₹5,000–₹15,000/year for ₹25 lakh cover", "Higher — ₹12,000–₹35,000/year for similar coverage"],
                ["Coverage scope", "Specific serious illnesses only (10–64 conditions)", "All hospitalisation, surgery, day care"],
                ["Complements or replaces?", "Complements regular health insurance", "Primary health coverage"],
            ] } },
            { id: "ci-what-covered", type: "rich_text", data: { content: "<h2>What Does Critical Illness Insurance Cover?</h2><p>The number of covered conditions varies by plan — basic plans cover 10–12 conditions; comprehensive plans cover 30–64 conditions. Core covered conditions in most plans include:</p><ul><li><strong>Cancer</strong> — all major/specified malignancies</li><li><strong>Heart Attack</strong> — first heart attack of specified severity</li><li><strong>Stroke</strong> — resulting in permanent neurological damage</li><li><strong>Kidney Failure</strong> — requiring regular dialysis or transplant</li><li><strong>Major Organ Transplant</strong> — heart, lung, liver, kidney, pancreas</li><li><strong>Coronary Artery Bypass Surgery</strong></li><li><strong>Paralysis of Limbs</strong> — permanent and irreversible</li><li><strong>Multiple Sclerosis</strong></li><li><strong>Aorta Surgery</strong></li><li><strong>Primary Pulmonary Arterial Hypertension</strong></li></ul>" } },
            { id: "ci-who-needs", type: "rich_text", data: { content: "<h2>Who Needs Critical Illness Insurance?</h2><ul><li><strong>Family history of cancer or heart disease:</strong> If parents or grandparents had these conditions, your risk is elevated.</li><li><strong>High-stress, sedentary lifestyle:</strong> Desk jobs, long hours, low physical activity, and poor diet increase lifestyle disease risk.</li><li><strong>Main income earner:</strong> A 6–12 month inability to work due to cancer treatment can devastate family finances even if the hospital bills are covered.</li><li><strong>Self-employed:</strong> Without employer sick leave, a serious illness means zero income for months. The CI lump sum replaces that income.</li></ul>" } },
            ...
            { id: "ci-cta2", type: "cta_block", data: { title: "Evaluate whether critical illness insurance makes sense for your profile — free expert consultation.", bookCallText: "Book a Free Call", whatsappText: "Chat on WhatsApp" } },
