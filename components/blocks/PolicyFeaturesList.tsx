            ...
            <div className="space-y-8">
                {(data.features || []).map((feature, i) => (
                    <div key={i} id={`feature-${i}`}>
                        <h3 className="font-semibold mb-2 flex items-center gap-3" style={{ fontFamily: "var(--font-heading)", color: "var(--text-primary)" }}>
                            <span
                        ...
                        <p className="text-sm leading-relaxed pl-9" style={{ color: "var(--text-secondary)", fontFamily: "var(--font-body)" }}>
                            {feature.body}
                        </p>
                    </div>
                ))}
