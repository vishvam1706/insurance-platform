...
async function seed() {
    ...
    // â”€â”€ INSURANCE PLANS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    await InsurancePlan.deleteMany({})
    console.log("ðŸ—‘  Cleared insurance plans")
    ...
    console.log("ðŸ—‘  Cleared testimonials")
    ...
    console.log("ðŸ—‘  Cleared page content")
        ...
        blocks: [
            {
                ...
                data: {
                    ...
                    reviewer: { name: "MS Bhati", role: "Certified Insurance Expert at Policymine", photo: "/images/bhati sir.png" },
            ...
            },
            {
                ...
                data: {
                    content:
                        "<p>Term insurance is a pure life insurance policy that provides financial protection for a specific period. If the policyholder passes away during that term, the insurer pays a lump sum death benefit to their beneficiaries. Multiple insurers sell various term insurance policies in the market.</p><p>At Policymine, our top recommendation is the <strong>Axis Max Life Smart Term Plan Plus</strong>, which offers features such as a critical illness rider for up to 20 years, an accelerated terminal illness benefit of â‚¹1 crore, and more. A 25-year-old individual seeking â‚¹2 crore coverage up to 65 years pays â‚¹17,222 annually for this plan.</p><p>But before you check out this product and other recommended plans, it's important to know more about the best term insurance plans. This guide is for those who want to know what is term insurance.</p><p>Indiaâ€™s life insurance market is growing, and the latest numbers are proof. according to India's Insurance Annual Report 2024-25, the average premium per person, or insurance density, rose to USD 97 in FY 2025 from USD 95 in FY 2024. Life insurance density also increased, reaching USD 72, up from USD 70 the previous year.</p><p>Amid this expanding market, term insurance stands out as a simple, cost-effective way to ensure your familyâ€™s financial security. It is the simplest form of life insurance: you pay a fixed premium for a fixed period, and if you pass away during the policy term, your nominee receives the sum assured. Letâ€™s discuss the features of term insurance, its types, premium comparison, and other details.</p>",
                },
            },
            {
                id: "advisor-cta",
            ...
            },
            {
                ...
                data: {
                    title: "Indicative Premium Comparison (â‚¹2 Crore Cover until Age 65, Non-Smoker, Pin Code: 110001)",
                    columns: ["Profile", "Axis Max Smart Term Plan Plus", "HDFC Life Click2Protect Supreme Plus", "ICICI Prudential iProtect Smart Plus"],
                    rows: [
                        ["25, Male", "â‚¹17,222", "â‚¹19,719", "â‚¹16,111"],
                        ["25, Female", "â‚¹14,640", "â‚¹16,761", "â‚¹13,694"],
                        ["30, Male", "â‚¹20,656", "â‚¹25,153", "â‚¹19,283"],
                        ["30, Female", "â‚¹17,558", "â‚¹21,380", "â‚¹16,391"],
                    ],
                },
            },
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    steps: [
                        { text: "<strong>Understand Your Policy:</strong> Review features, benefits, exclusions, and claim metrics, so you know whatâ€™s covered, what isnâ€™t, and how reliable the insurer is." },
            ...
            },
            {
                ...
                data: {
                    content:
                        "<h2>Tax Benefits of Term Insurance</h2><p>There are three major term insurance tax benefits in India:</p><ul><li>Tax deductions up to â‚¹1.5 lakh on premiums paid under Section 80C (old tax regime).</li><li>Tax-free payouts to nominees under Section 10(10D), regardless of regimes.</li><li>Tax deductions on premiums paid under certain riders, like critical illness, within the Section 80D limits (old regime).</li></ul>",
                },
            },
            {
                id: "gst-update-box",
            ...
            },
            {
                ...
                data: {
                    ...
                    steps: [
                        { text: "The nominee should first inform the insurer as soon as possible through the insurerâ€™s website, branch, email, or helpline." },
                        { text: "They must submit the claim form along with key documents, including the death certificate, policy documents, the nomineeâ€™s KYC, bank details, and medical or police records, if applicable." },
                        ...
                        { text: "Once the claim is approved, the insurer pays the death benefit to the nomineeâ€™s registered bank account." },
                    ],
                },
            },
            {
                ...
                data: {
                    ...
                    content: "Under India's policyholder protection framework (2024), life insurers must settle or reject a death claim within 15 days of receiving all required claim documents and clarifications, if no investigation is needed. If an investigation is required, it must be completed within 45 days of claim submission. Any delay beyond these timelines attracts interest at the bank rate plus 2%, payable along with the claim amount.",
                },
            },
            {
                id: "why-choose-us",
                ...
                data: {
                    ...
                    items: [
                        ...
                        },
                        {
                            name: "Ragul Kumar",
                            initials: "RK",
                            body: "Loved the service! Maheta Nidhi Hitesh was incredibly helpful and knowledgeable. She guided me through the whole process and made everything super easy to understand. I really appreciated how patient she was with all my questionsâ€”there was no pressure at all, just clear and honest advice. Honestly, I'm very happy with my experience at Policymine so far. Highly recommend!",
                        },
                        {
                            name: "Pulkit Singh",
                            initials: "PS",
    ...
    await PageContent.create({
        ...
        blocks: [
            ...
            },
            {
                ...
                data: {
                    content:
                        "<p>To buy term insurance in India, start by comparing reliable insurers, choosing the right life cover, checking documents, and completing the process online. A standard â‚¹2 crore cover starts at around â‚¹20,000 per year for a 30-year-old healthy, non-smoking male, until age 65. Premiums differ based on your age, gender, policy term, health status, and lifestyle habits.</p><p>Policymineâ€™s top recommendation for 2026 is Smart Term Plan Plus, by Axis Max Life, backed by a 99.62% average claim settlement ratio across FY 2022-25. We rate plans based on insurer reliability, claim settlement ratio, amount settlement ratio, solvency, complaints, features, flexibility, and premiums.</p><p>This guide is for salaried earners, young families, and first-time buyers who want to confidently buy term insurance online.</p><p>India's life insurance penetration stood at just 2.7% of GDP in FY 2024-25, according to India's insurance industry annual report. That means an overwhelming majority of Indian families have no financial safety net if the breadwinner passes away unexpectedly.</p><p>If something happens to you tomorrow, your family does not just lose you. They lose your income, their ability to pay the home loan EMI, fund your child's education, and manage day-to-day expenses.</p><p>This is exactly why buying term insurance is one of the most important financial decisions you can make. And the best time to do it was yesterday.</p><p>This guide covers term insurance basics, Policymineâ€™s top 2026 picks, key buying tips, steps for an online purchase, and the required documents.</p>",
                },
            },
            {
                id: "buy-advisor-cta",
            ...
            },
            {
                ...
                data: {
                    ...
                    rows: [
                        ["25, Male", "â‚¹17,222", "â‚¹19,719", "â‚¹16,111", "â‚¹15,474", "â‚¹18,607"],
                        ["25, Female", "â‚¹14,640", "â‚¹16,761", "â‚¹13,694", "â‚¹14,482", "â‚¹16,343"],
                        ["30, Male", "â‚¹20,656", "â‚¹25,153", "â‚¹19,283", "â‚¹20,132", "â‚¹21,767"],
                        ["30, Female", "â‚¹17,558", "â‚¹21,380", "â‚¹16,391", "â‚¹16,234", "â‚¹18,235"],
                    ],
                },
            },
            {
                ...
                data: {
                    label: "Premium Note",
                    content: "For the above example, weâ€™ve considered healthy, non-smoking, salaried individuals living in a tier-1 city such as Delhi (pincode: 110010), covered for a sum assured of â‚¹2 crore until age 65. The premiums are indicative and can vary based on your age, health conditions, lifestyle choices, and underwriting decisions.",
                },
            },
            {
            ...
            },
            {
                ...
                data: {
                    ...
                    cards: [
                        { number: 1, title: "Evaluate the Insurer, Not Just the Plan", body: "Check the insurerâ€™s 3-year average Claim Settlement Ratio (CSR), Amount Settlement Ratio (ASR), and solvency ratio. Ideally, CSR should be above 97%, ASR above 90%, low complaints volume (less than 20 per 10,000 claims), and solvency above the regulatory-mandated 1.5x." },
                        ...
                        { number: 3, title: "Pick the Right Policy Tenure", body: "Your term plan should cover your peak-earning and liability years, ideally through at least age 60 to 65. Factor in home loans, childrenâ€™s financial independence, and other long-term responsibilities." },
            ...
            },
            {
                ...
                type: "policymine_take",
                data: {
                    title: "Policymineâ€™s Take on Buying Term Insurance",
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "Term Insurance vs Life Insurance â€” Key Differences 2026",
        ...
        blocks: [
            ...
            },
            {
                ...
                data: {
                    content:
                        "<p>Term insurance is a type of pure-protection life insurance that provides a death benefit if the policyholder passes away during the policy term. On the other hand, life insurance is a broader category that includes policies that combine savings or market-linked investment with insurance and provide a payout at maturity if you survive.</p><p>The premiums for both categories are quite different. For instance, a 30-year-old individual seeking a â‚¹1 crore cover pays â‚¹14,997 under the HDFC Click 2 Protect Supreme Plus term plan (one of our top recommendations). However, the premium under the return of premium version is â‚¹34,868 for the same profile.</p><p>This guide is ideal for those who want to learn how life insurance or term insurance works, what they pay out, and who they truly make sense for.</p><p>Indiaâ€™s insurance market today is packed with options, from digital-first insurers to more transparent products. According to India's Insurance Annual Report (FY 2024-25), Indiaâ€™s overall insurance penetration stands at 3.7%, with life insurance at 2.7% and non-life insurance at 1%.</p><p>At the same time, more households are becoming aware of how insurance can protect their familyâ€™s future against unexpected risks. This is where one common question comes in: term insurance vs life insurance. Should you choose a simple, affordable term plan that offers a large safety net? Or should you pick a broader life insurance product that combines protection with savings or investment?</p>",
                },
            },
            {
                id: "vs-advisor-cta",
            ...
            },
            {
                ...
                type: "comparison_table",
                data: {
                    title: "Term vs TROP Premiums (30-year-old Male, â‚¹1 Crore cover up to 65 years, HDFC Life)",
            ...
            },
            {
                ...
                data: {
                    ...
                    rows: [
                        ["Guaranteed Maturity", "â‚¹1,00,000", "20 Years", "10 Years", "â‚¹25,63,120 paid as a lump sum at maturity"],
                        ["Guaranteed Income", "â‚¹1,25,000", "13 Years", "12 Years", "Guaranteed income of â‚¹2,04,000 PA from 14th year to 25th year (12-year payout)"],
                        ["Long Term Income", "â‚¹1,25,000", "11 Years", "10 Years", "Guaranteed income of â‚¹98,250 PA from 12th to 36th year + â‚¹10,00,000 at end"],
                        ["Life Long Income", "â‚¹1,05,000", "11 Years", "10 Years", "Guaranteed income of â‚¹81,250 PA from 12th year till age 99 + â‚¹1,00,000 at end"],
                    ],
                },
            },
            {
                ...
                type: "comparison_table",
                data: {
                    title: "ULIP Premiums (HDFC Life Sampoorn Nivesh Plus, 30-year-old, â‚¹20 SA for 30 years)",
                    columns: ["Particulars", "Details"],
                    rows: [
                        ["Plan Option", "Classic Benefit (Extra Life Option)"],
                        ["Policy Term", "30 Years"],
                        ["Premium Payment Term", "10 Years"],
                        ["Annual Premium", "â‚¹1,00,000"],
                        ["Total Premiums Paid", "â‚¹10,00,000"],
                        ["Maturity Benefit at 8% PA", "â‚¹43,45,970"],
                        ["Maturity Benefit at 4% PA", "â‚¹13,94,698"],
                        ["Death Benefit During Term", "â‚¹20,00,000 or fund value, whichever is higher"],
                    ],
                },
            },
            {
                ...
                type: "policymine_take",
                data: {
                    title: "Policymineâ€™s Expert Insights on Term Insurance vs Life Insurance",
                    body: "Shrehith, our co-founder, says that term insurance is more important than other types of life insurance. According to him, the idea is simple: 'Insurance should primarily be about protection, not investment. Thatâ€™s the problem with many other life insurance products. They mix insurance with savings or investments, but often donâ€™t offer enough returns or enough protection. This is where term insurance has a clear advantage. It keeps things clean: you pay a low premium and get a high life cover, ensuring your family has strong financial protection if something happens to you.'",
                },
            },
            {
                id: "vs-how-to-choose",
            ...
            },
            {
                ...
                data: {
                    ...
                    body: "At Policymine, we recommend pure term insurance as the most efficient choice in the term insurance vs life insurance debate. It offers a large cover at a low premium because it does not mix protection with investment. Traditional plans like endowment, money-back, or ULIPs usually offer lower cover, higher costs, modest returns, and long lock-ins. For most people, itâ€™s smarter to keep both goals separate: use term insurance for protection and options such as mutual funds, the Public Provident Fund (PPF), or Fixed Deposits (FDs) for wealth creation.",
                },
            },
            {
                id: "vs-faq",
    ...
    await PageContent.create({
        ...
        blocks: [
            ...
            },
            {
                ...
                data: {
                    title: "Comparing Insurers â€” How to decide which insurance company is better?",
                    metrics: [
                        {
                            number: 1,
                            title: "Track Record",
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "Best Term Insurance Plans in India 2026 â€” Compare & Save",
        ...
        blocks: [
            ...
            },
            {
                ...
                data: {
                    content:
                        "<h2>Policymineâ€™s Rating Methodology</h2><p>To find the true best term insurance plan, we run them through a proprietary scoring matrix. All plans included in this guide are rated using our transparent policy rating framework, which scores each plan across three dimensions and 15+ factors:</p><ul><li><strong>Insurer Reliability (60%):</strong> We average insurer-reported data (CSR, ASR, Solvency, Complaints) over the last 3 years to ensure an insurer performs consistently, so a single good or bad year doesnâ€™t skew the rating.</li><li><strong>Product Features (30%):</strong> We analyze the fine print of policy brochures to measure how comprehensive the policy is. Does the policy offer premium deferment? Is the terminal illness benefit built in or charged extra? Are the terms rigid or flexible?</li><li><strong>Pricing (10%):</strong> We compare quotes across various ages, genders, and smoking habits to see which plans offer the best value for your money.</li></ul>",
                },
            },
            {
                id: "best-plans-table",
                type: "plans_table",
                data: {
                    title: "Best Term Insurance Plan in India: Policymineâ€™s Top 5 Choices",
                    rows: [
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "1 Crore Term Insurance Plans â€” Premiums & Eligibility",
        ...
        blocks: [
            {
                ...
                data: {
                    ...
                    reviewer: { name: "MS Bhati", role: "Insurance Expert at Policymine", photo: "/images/bhati sir.png" },
                },
            },
            {
                id: "oc2",
            ...
            },
            {
                ...
                type: "features_table",
                data: {
                    title: "Estimated Monthly Premiums for â‚¹1 Crore Cover (Non-Smoker)",
                    note: "Estimated premiums for a regular cover up to age 60. Actual premiums vary based on medical test results.",
                    rows: [
                        { aspect: "Age 25", feature: "â‚¹800 to â‚¹1,000 per month" },
                        { aspect: "Age 30", feature: "â‚¹1,000 to â‚¹1,300 per month" },
                        { aspect: "Age 35", feature: "â‚¹1,400 to â‚¹1,800 per month" },
                        { aspect: "Age 40", feature: "â‚¹2,000 to â‚¹2,500 per month" },
                    ],
                },
            },
            {
                ...
                data: {
                    ...
                    items: [
                        ...
                        { heading: "Affordable Cost", body: "At young ages, a â‚¹1 Crore term plan costs less than â‚¹30 a day, making it highly pocket-friendly." },
                    ],
                },
            },
            {
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "NRI Term Insurance India â€” Rules & Buying Guide 2026",
        ...
        blocks: [
            ...
            },
            {
                ...
                type: "cta_block",
                data: {
                    title: "Connect with our specialized NRI support desk now. Get free, unbiased guidance from certified insurance advisors.",
        ...
        blocks: [
            ...
            },
            {
                ...
                data: {
                    ...
                    body: "Health insurance is not a wealth-creation tool; it is a shield for your savings. A single major hospitalization can cost upwards of â‚¹5 lakhs today. Keeping a comprehensive individual or family health policy ensures you get high-quality healthcare without financial distress.",
                },
            },
            {
                id: "health-faq",
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "Best Health Insurance Plans in India 2026 â€” Compare",
    ...
    await PageContent.create({
        ...
        published: true,
        seo: {
            metaTitle: "Family Floater Health Insurance Plans â€” Save on Premiums",
        ...
        blocks: [
            ...
            },
            {
                ...
                type: "rich_text",
                data: {
                    content: "<p>A Family Floater Health Insurance plan covers your entire family (spouse, children, and parents) under a single shared sum assured. For instance, a â‚¹10 Lakh sum assured can be utilized by any member of the family during the year. This is highly cost-effective and much easier to manage than paying for 4 separate policies.</p>",
                },
            },
            {
                id: "fh3",
        ...
        blocks: [
            {
                ...
                data: {
                    ...
                    subtitle: "Get personalized insurance guidance, transparent plan comparisons, and expert claim support â€” all in one place.",
                    ...
                    stats: [
                        { label: "Trusted Insurance Advisors", value: "âœ”" },
                        { label: "Personalized Plan Comparison", value: "âœ”" },
                        { label: "Claim Support Assistance", value: "âœ”" },
                        { label: "Multi-Language Guidance", value: "âœ”" },
                        { label: "End-to-End Support", value: "âœ”" }
                    ]
                }
            },
            {
                ...
                data: {
                    stats: [
                        ...
                        { label: "Premium Managed", value: "â‚¹400Cr+" },
            ...
            },
            {
                ...
                data: {
                    ...
                    subtitle: "We help customers make smarter protection decisions based on their financial goals, responsibilities, lifestyle, and future needs â€” not rigid sales targets.",
            ...
            },
            {
                ...
                data: {
                    title: "Insurance Should Be Understood â€” Not Just Purchased",
                    ...
                    items: [
                        { title: "The Knowledge Gap", desc: "Most people buy insurance without fully understanding what is actually covered, what is excluded, or how claims work during difficult situations. Thatâ€™s where we help." },
                        ...
                        { title: "Confident Protection", desc: "Whether you are planning for family protection, health security, wealth creation, retirement, or your childâ€™s future â€” choose the right financial safety net with total confidence." }
                    ]
                }
            },
            {
                ...
                data: {
                    ...
                    cards: [
                        { title: "Term Insurance", desc: "Secure your familyâ€™s financial future with high life coverage at affordable premiums.", href: "/term-life", colorClass: "bg-blue-600" },
                        ...
                        { title: "Child Future Planning", desc: "Plan confidently for your childâ€™s education, marriage, and future aspirations.", href: "/child-future", colorClass: "bg-purple-600" },
            ...
            },
            {
                ...
                data: {
                    ...
                    bookCallText: "Schedule a Free Consultation",
    ...
    await PageContent.create({
        ...
        blocks: [
            { id: "c1", type: "hero", data: { title: "Get In Touch With Our Insurance Experts", subtitle: "Whether you need help understanding plans, comparing policies, or getting claim support â€” our team is here to guide you." } },
    ...
    await PageContent.create({
        ...
        blocks: [
            { id: "a1", type: "hero", data: { title: "Building Trust Through Smarter Insurance Guidance", subtitle: "Policymine was created with a simple mission â€” to make insurance easier to understand, transparent, and customer-focused." } },
    ...
    await PageContent.create({
        ...
        section: "term-life",
        published: true,
        seo: { metaTitle: "Term Insurance - Policymine", metaDescription: "Protect Your Familyâ€™s Financial Future" },
        blocks: [
            { id: "tl1", type: "hero", data: { title: "Protect Your Familyâ€™s Financial Future", subtitle: "Term insurance provides financial protection for your loved ones in case of unforeseen circumstances." } },
            { id: "tl2", type: "benefits_list", data: { title: "Why Term Insurance Matters", items: [{ heading: "Affordable", body: "High life coverage at affordable premiums" }, { heading: "Protection", body: "Financial protection for dependents" }, { heading: "Tax Savings", body: "Tax benefits as per applicable laws" }, { heading: "Peace of Mind", body: "Peace of mind for your familyâ€™s future" }] } },
    ...
    await PageContent.create({
        ...
        section: "wealth",
        published: true,
        seo: { metaTitle: "Child Future Planning - Policymine", metaDescription: "Secure Your Childâ€™s Future Goals" },
        blocks: [
            { id: "cf1", type: "hero", data: { title: "Secure Your Childâ€™s Future Goals", subtitle: "Prepare confidently for your childâ€™s future education, career goals, and important life milestones." } },
    ...
    await PageContent.create({
        ...
        blocks: [
            { id: "tc1", type: "rich_text", data: { content: "<h2>Terms Of Use</h2><p>By accessing this website and using our services, users agree to the applicable terms, policies, and regulatory guidelines.</p><p>Policymine provides insurance-related guidance and assistance services. Final policy issuance, underwriting, premium decisions, and claim settlement are governed by the respective insurerâ€™s terms and conditions. Users are advised to review all policy documents carefully before making purchase decisions.</p>" } }
        ]
    });

    // â”€â”€ HERO CONTENT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    await HeroContent.deleteMany({})
    console.log("ðŸ—‘  Cleared hero content")
    ...
    try {
        ...
        console.log("âœ… Detailed pages seeded successfully")
    } catch (err) {
        console.error("âŒ Detailed pages seed failed:", err)
    }
