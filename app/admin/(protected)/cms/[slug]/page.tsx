        ...
        <div className="space-y-5 max-w-4xl">
            ...
            <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    />
                    <p className="text-xs text-slate-400 font-mono mt-0.5">/{pageKey}</p>
                </div>
                ...
                {seoOpen && (
                    <div className="px-5 pb-5 space-y-4 border-t border-slate-100">
                        <div className="space-y-1.5 mt-4">
                            <Label className="text-xs text-slate-500">Meta Title <span className="text-slate-300">(max 60 chars)</span></Label>
                            <Input
                                value={metaTitle}
                                ...
                                maxLength={60}
                            />
                            <p className="text-xs text-slate-300 text-right">{metaTitle.length}/60</p>
                        </div>
                        <div className="space-y-1.5">
                            <Label className="text-xs text-slate-500">Meta Description <span className="text-slate-300">(max 160 chars)</span></Label>
                            <Textarea
                                value={metaDesc}
                                ...
                                rows={3}
                            />
                            <p className="text-xs text-slate-300 text-right">{metaDesc.length}/160</p>
                        </div>
                        <div className="space-y-1.5">
