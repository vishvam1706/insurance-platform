...
export default function InquiryTable({ inquiries, pagination, loading, onPageChange, onRefetch }: InquiryTableProps) {
    ...
    useEffect(() => {
        ...
        axios.get("/api/users", { params: { role: "employee", status: "active", limit: 200 } })
            .then(res => setEmployees(res.data.users?.map((u: any) => ({
                _id: u._id,
                name: u.name,
                email: u.email,
                states: u.states || [],
    ...
    return (
        <div className="relative w-full" ref={containerRef}>
            ...
            >
                ...
                {/* Display detail badges for selected employee */}
                {selected && (
            ...
            {/* Dropdown list absolute positioning */}
            {open && (
